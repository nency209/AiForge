export default function Footer() {
  return (
    <>
      <footer className="flex flex-wrap justify-center lg:justify-between overflow-hidden gap-10 md:gap-20 py-16 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-gray-500 bg-gray-400">
        <div className="flex flex-wrap items-start gap-10 md:gap-[60px] xl:gap-[140px]">
          ...
          <div>
            ...
            <ul className="mt-2 space-y-2">
              <li>
                <a href="/" className="hover:text-indigo-600  text-white transition">
                  Home
                </a>
              </li>
              <li>
          ...
          <div className="flex items-center gap-4 mt-3">
            ...
            >
              <svg
                ...
                strokeLinecap="round"
                strokeLinejoin="round"
                className="lucide lucide-dribbble size-5 hover:text-indigo-500 text-white  "
                aria-hidden="true"
              >
            ...
            >
              <svg
                ...
                strokeLinecap="round"
                strokeLinejoin="round"
                className="lucide lucide-linkedin size-5 hover:text-indigo-500 text-white"
                aria-hidden="true"
              >
            ...
            <a href="https://x.com/prebuiltui" target="_blank" rel="noreferrer">
              <svg
                ...
                strokeLinecap="round"
                strokeLinejoin="round"
                className="lucide lucide-twitter size-5 hover:text-indigo-500 text-white"
                aria-hidden="true"
              >
            ...
            >
              <svg
                ...
                strokeLinecap="round"
                strokeLinejoin="round"
                className="lucide lucide-youtube size-6 hover:text-indigo-500 text-white"
                aria-hidden="true"
              >
